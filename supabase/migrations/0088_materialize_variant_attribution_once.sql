-- ═══════════════════════════════════════════════════════════════════════════
-- 0088 — Attribute once; a sequence report must return before its timeout.
--
-- This repeats 0087's semantics but materializes the filtered attribution rows once.
